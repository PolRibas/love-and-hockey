            ...
            <div className="border-t border-gray-200">
                <dl>
                    {standings.map((team, i) => (
                        <div key={i} className={`${i % 2 === 0 ? 'bg-gray-50' : 'bg-white'} px-4 py-5 grid grid-cols-6 gap-4 sm:px-6`}>
                            <dt className="text-sm font-medium text-gray-500 col-span-2">
                                {team.team.name}
                            </dt>
                            <dd className="mt-1 text-sm text-gray-900 sm:mt-0 col-span-1 text-black">
                                P: {team.points}
                            </dd>
